...
public class DriveToPoseCommand extends Command {
  ...
  public void execute() {
      ...
      ChassisSpeeds chassisSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(movingx * DriveConstants.kPIDDriveMaxSpeedMetersPerSecond / 1.5, movingy * DriveConstants.kPIDDriveMaxSpeedMetersPerSecond / 1.5, steeringAdjust * DriveConstants.kPIDDriveMaxAngularSpeedRadiansPerSecond / 4, swerveSubsystem.getEstimatedPose().getRotation());
