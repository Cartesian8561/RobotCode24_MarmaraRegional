...
/* 
        ...
        */
        ...
        public static final double kFrontLeftDriveAbsoluteEncoderOffsetRad = 2.86;
        public static final double kBackLeftDriveAbsoluteEncoderOffsetRad = -2.12;
        public static final double kFrontRightDriveAbsoluteEncoderOffsetRad = 0.2 + Math.PI;
        public static final double kBackRightDriveAbsoluteEncoderOffsetRad = 1.29;

        public static final double kPhysicalMaxSpeedMetersPerSecond = 5.0;
        public static final double kPhysicalMaxAngularSpeedRadiansPerSecond = 2 * 2 * Math.PI;

        public static final double kTeleDriveMaxSpeedMetersPerSecond = kPhysicalMaxSpeedMetersPerSecond / 1.5;//4
        ...
        public static final double kPIDDriveMaxSpeedMetersPerSecond = kPhysicalMaxSpeedMetersPerSecond / 2.0;//4
        public static final double kPIDDriveMaxAngularSpeedRadiansPerSecond = 
        kPhysicalMaxAngularSpeedRadiansPerSecond / 2;//4
        public static final double kPIDDriveMaxAccelerationUnitsPerSecond = 3;
        public static final double kPIDDriveMaxAngularAccelerationUnitsPerSecond = 3;
    ...
    public static final class DahaIyiField {
        public static Rotation2d fieldFront = (!isBlueAlliance) ? new Rotation2d() : new Rotation2d(Math.PI);
        public static Translation2d speaker = allianceFlip(new Translation2d(16.5, 5.4)); //15.61 5.55
        public static Pose2d amp = allianceFlip(new Pose2d(14.72, 7.86, new Rotation2d()));
        public static Pose2d source = allianceFlip(new Pose2d(0.93, 0.85, new Rotation2d(Math.PI / 3)));
    ...
    public static final boolean isBlueAlliance = true; //blue true
