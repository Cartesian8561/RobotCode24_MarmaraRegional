...
public class goToSpeaker extends Command {
  ...
  public void execute() {
    ...
    ChassisSpeeds chassisSpeeds = ChassisSpeeds.fromFieldRelativeSpeeds(0.0, 0.0, steeringAdjust * DriveConstants.kTeleDriveMaxAngularSpeedRadiansPerSecond / 3.0, swerveSubsystem.getRotation2d());
